...
//functions
function showName(){
    echo "My name is Sabrina Sumona".'<br>';
}
showName();
...
function showName3($name='Naorin', $n=0){
    echo "My name is ". $name.'<br>';
    return $n+1;
}
$n= 1;
$num = showName3('Minu', $n);
echo 'num = '.$num.'<br>';
$n= 5;
$num= showName3('Tushi', $n);
echo 'num = '.$num.'<br>';

// if we don't pass any value, the default value will be shown
$num = showName3();
echo 'num = '.$num.'<br>';
?>